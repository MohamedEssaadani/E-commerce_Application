...
class CartController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('cart.index')->with('success_message', 'Item was added to your cart successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        //redirect()->route('cart.index')->with('success_message', 'Item has been removed!');
        return back()->with('success_message', 'Item has been removed!');
    }

    /**
     * Switch item of shopping cart to save for later.
     *
     * @param  int  $id
     * @return \Illuminate\Http\Response
     */
